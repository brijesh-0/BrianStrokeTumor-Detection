# -*- coding: utf-8 -*-
"""Brain Tumor Flask.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dVumJvBjM9XvnntwdmnPyHcjsiQ48P-O
"""
...
def showPredictsById(t1ce, flair, seg, start_slice = 60):
    ...
    plt.savefig('sample_data/uploads/plots_bw.png', format='png', dpi=300)
    plt.show()
...
def show_predicted_segmentations(t1ce, flair, seg, slice_to_plot, cmap, norm):
    ...
    plt.savefig('sample_data/uploads/plots_color.png', format='png', dpi=300)
    plt.show()
